...
do
	echo
	read -p "Please input domain(example: www.lempstack.com): " domain
...
if [ "$moredomainame_yn" == 'y' ]; then
        ...
        do
                echo
                read -p "Type domainname,example(lempstack.com www2.lempstack.com): " moredomain
...
if [ "$rewrite_yn" == 'n' ];then
	...
	echo -e "\033[32mwordpress\033[0m,\033[32mdrupal\033[0m,\033[32mjoomla\033[0m,\033[32mdiscuz\033[0m,\033[32mphpwind\033[0m,\033[32mtypecho\033[0m,\033[32mecshop\033[0m, rewrite was exist."
...
if [ -d "$web_install_dir" ];then
	...
	echo -e "Nginx/Tengine not exist! "
fi 
